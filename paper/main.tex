...
On a 40-task benchmark spanning five domains (code, math, planning,
science, web), \nous{} achieves $F_1 = 0.842$ with precision $0.889$
and recall $0.800$, outperforming a naive single-prompt baseline on
precision (critical for agent monitoring).
...
\begin{enumerate}
  ...
  \item \textbf{Evaluation.} 40-task benchmark across 5 domains.
    $F_1 = 0.842$, precision $0.889$. Open-source with all artifacts.
\end{enumerate}
...
All four of our false negatives occur in non-decidable violation types.
